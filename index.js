...
console.log(makePersonObject(1, "Adonis", "adonis-puente@hotmail.com"));
...
function getCarInfoByIndex(inventory, index) {
  ...
  return `The car is a ${carInfo.car_make} ${carInfo.car_model}`;
}
/**
